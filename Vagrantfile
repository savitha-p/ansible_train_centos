...
#  ansiblehost.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.3", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
...
#####################controller configuration#####################
  ...
  controller.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.4", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
  ...
  controller.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.5", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
...
###########################compute configuration#########################
  ...
  compute.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.6", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
  compute.vm.network "public_network", :type => "bridge", :dev => "virbr2", auto_config: true, use_dhcp_assigned_default_route: true
  compute.vm.network "public_network", :type => "bridge", :dev => "virbr2", auto_config: true, use_dhcp_assigned_default_route: true
  compute.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.7", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
...
##########################cephmon configuration#########################
  ...
  mon.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.8", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
  mon.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.9", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
...
##########################osd1 configuration#########################
  ...
  osd1.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.10", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
  osd1.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.11", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
...
##########################osd2 configuration#########################
  ...
  osd2.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.12", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
  osd2.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.13", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
...
###########################osd3 configuration#########################
  ...
  osd3.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.14", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
  osd3.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.15", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
...
##########################iscsi configuration#########################
  ...
  iscsi.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.16", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
  iscsi.vm.network "public_network", :type => "bridge", :dev => "virbr2", :ip => "10.10.10.17", :netmask => "255.255.0.0", :gateway => "10.10.10.1"
